    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <a href="/adminlte/dist/index2.html"
                ...
                <form action="{{ route('login.process') }}" method="POST">
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="nameServer" type="text" class="form-control" name="server_name" value=""
                                placeholder="" required />
                            <label for="nameServer">Server Name</label>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary">Connect SQL Server</button>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
